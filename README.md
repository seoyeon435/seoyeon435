...
---
서연님의 전체 리드미(README.md) 흐름에 맞춰, 기존 내용과 잘 어우러지도록 깔끔하게 정리한 최종 코드입니다. 이 내용을 그대로 복사해서 사용하시면 됩니다.
...
| 대학생을 위한 데스크탑 전용 플래너 | HTML, CSS, JavaScript | 2025.06 | LikeLion | [Repo](https://github.com/LikeLion-at-DGU/2025-simba-6-BeBee.git) |
| 동네소리를 공유하는 커뮤니티 서비스 | JavaScript, React, Vite, Netlify | 2025.08 | LikeLion | [Repo](https://github.com/LikeLion-at-DGU/2025-hackathon-4-WETOWN-frontend) |
| 2025 한국문화관광연구원 공모전 | SPSS, Python | 2025.08 | BAF | **🏆 대상** |
...
| AI 발표 지원 서비스 '보이니' |  JavaScript, React, Vite, Netlify | 2025.11 ~ 2025.12 | LikeLion | **🏆 대상** [Repo](https://github.com/likelion-line4thon-crushers/line4thon-presentation-frontend.git) |
